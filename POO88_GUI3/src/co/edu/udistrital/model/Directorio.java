...
public class Directorio {
	...
	private HashSet<Persona> directorio;

	public Directorio() {
		directorio = new HashSet<Persona>();
	...
	public HashSet<Persona> getDirectorio() {
		return directorio;
	}

	public void setDirectorio(HashSet<Persona> directorio) {
